...
interface HiroshimaYearClientProps {
  data: EkidenData
  year: number
}

export function HiroshimaYearClient({ data, year }: HiroshimaYearClientProps) {
    ...
    <>
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 lg:px-8 py-8">
          <Link href="/ekiden/hiroshima" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4 text-sm">
