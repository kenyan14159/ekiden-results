...
interface JuniorHighWomenYearClientProps {
  data: EkidenData
  year: number
}

export function JuniorHighWomenYearClient({ data }: JuniorHighWomenYearClientProps) {
    ...
    <>
      <div className="bg-white border-b">
        <div className="container mx-auto px-4 lg:px-8 py-8">
          <Link href="/ekiden/junior-high-women" className="inline-flex items-center text-gray-600 hover:text-gray-900 mb-4 text-sm">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-right">
                        ...
                        <div className="text-lg font-bold text-gray-900">{removeLeadingZero(team.totalTime)}</div>
                      </div>
                      <svg 
