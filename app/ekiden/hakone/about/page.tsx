      ...
      <main className="flex-grow pt-20">
        ...
        <div className="bg-white border-b">
          <div className="container mx-auto px-4 lg:px-8 py-12">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">箱根駅伝 区間特徴</h1>
            <p className="text-lg text-gray-600 mb-2">箱根駅伝10区間の個性をこれでもかと味わい尽くす！</p>
            <p className="text-sm text-gray-500">総合距離は217.1km、標高差800m超の激闘を経て決まる王者決定戦。区間ごとの"クセ"や"心理戦"、そしてドラマを詳細に解説します。</p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <section className="mb-16">
              <div className="bg-blue-50 border-l-4 border-blue-600 px-6 py-4 mb-8">
                <h2 className="text-2xl font-bold text-gray-900">往路（1区〜5区）</h2>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">1区（21.3km）</h3>
                    <p className="text-sm font-medium text-blue-600">序盤のパワーバランス調整人</p>
                  </div>
                </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">2区（23.1km）</h3>
                    <p className="text-sm font-medium text-blue-600">花の2区の権太坂バトル</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">3区（21.4km）</h3>
                    <p className="text-sm font-medium text-blue-600">絶景＆向かい風覚悟のフリーライド区間</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">4区（20.9km）</h3>
                    <p className="text-sm font-medium text-blue-600">"延長された平常心テスト"区間</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">5区（20.8km）</h3>
                    <p className="text-sm font-medium text-blue-600">山上り＆ダウンヒルの心臓破り</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
            ...
            {/* 復路セクション */}
            <section className="mb-16">
              <div className="bg-green-50 border-l-4 border-green-600 px-6 py-4 mb-8">
                <h2 className="text-2xl font-bold text-gray-900">復路（6区〜10区）</h2>
              </div>
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">6区（20.8km）</h3>
                    <p className="text-sm font-medium text-green-600">スリリングな一気下り区間</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">7区（21.3km）</h3>
                    <p className="text-sm font-medium text-green-600">気温ジェットコースター地帯</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">8区（21.4km）</h3>
                    <p className="text-sm font-medium text-green-600">追い風の罠＆体力消耗ルーレット</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">9区（23.1km）</h3>
                    <p className="text-sm font-medium text-green-600">大逆転を呼ぶドラマ区間</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-gray-900 mb-1">10区（23.0km）</h3>
                    <p className="text-sm font-medium text-green-600">歓声浴びてゴールへラストスパート</p>
                  </div>
                </div>
                <p className="text-gray-700 leading-relaxed">
