        ...
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="flex items-center space-x-3 group">
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl blur-sm opacity-70 group-hover:opacity-100 transition-opacity"></div>
          ...
          <nav className="hidden lg:flex items-center space-x-1 flex-1">
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  <button className="px-4 py-2.5 text-sm font-medium text-gray-700 hover:text-gray-900 relative group">
                    {category.name}
                    <svg
